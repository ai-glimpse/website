    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h1 className="text-gray-1000 text-3xl leading-7 font-semibold">
            {featureTitle.name}
          </h1>
              ...
              <Link key={feature.name} href={`${rootPath}/${feature.path}`}>
                <div key={feature.name} className="relative pl-16">
                  <dt className="text-base leading-7 font-semibold text-gray-900">
                    <div
                      className={`absolute top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg ${feature?.iconColor ?? 'bg-indigo-600'}`}
                    >
                      <feature.icon
