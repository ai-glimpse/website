...
const Feature = ({
  ...
  return (
    <Card className="flex flex-col items-center bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
        ...
        <div className="flex flex-col items-center space-y-16">
          <div className="container mx-auto max-w-3xl space-y-4 text-center">
            ...
            <p className="text-lg text-gray-700 md:text-xl">
              We&apos;re on a mission to democratize AI education, making it
              accessible, engaging, and practical for learners of all levels.
            </p>
          </div>
          ...
          <Card className="max-w-3xl rounded-xl bg-gray-50 p-8 text-center shadow-xl">
            <h3 className="mb-4 text-lg font-semibold text-gray-700 md:text-xl">
              Your Journey in AI Starts Here
            </h3>
            <p className="mb-6 text-lg text-gray-700">
              Whether you&apos;re taking your first steps in AI or looking to
              deepen your expertise, our platform offers the tools and community
              to support your growth. Dive in, experiment with our
              &apos;toys&apos;, and don&apos;t hesitate to share your insights
